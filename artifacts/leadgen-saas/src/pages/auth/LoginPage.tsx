...
import { z } from "zod";
import { Eye, EyeOff, BarChart3, ShieldCheck, Sparkles, ArrowRight, CheckCircle2, TrendingUp, Target, Lightbulb, Megaphone } from "lucide-react";
...
const benefits = [
  {
    ...
    description: "High-intent prospects ranked automatically so you focus on the best opportunities.",
  },
  {
    icon: ShieldCheck,
    title: "Verified & Daily",
    description: "Fresh, verified leads delivered to your inbox every morning.",
  },
];
...
const FormCard = ({
  ...
  return (
    <div className="group w-full max-w-[560px] bg-background/80 dark:bg-card/80 backdrop-blur-xl rounded-2xl border border-border/50 shadow-xl hover:shadow-2xl transition-all duration-500 p-10 focus-within:glow-sm">
      ...
      <p className="text-sm text-muted-foreground mb-8">Sign in to continue to your account</p>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm text-primary hover:underline cursor-pointer font-medium transition-all hover:scale-105">
              Forgot password?
            </span>
          </div>
      ...
      <p className="mt-6 text-center text-sm text-muted-foreground">
        ...
        <Link href="/register">
          <span className="text-primary hover:underline cursor-pointer font-medium transition-all hover:scale-105 inline-block">
            Sign up
          </span>
        </Link>
      </p>
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="absolute top-4 right-4 z-30">
        <div className="relative">
          <div className="absolute -inset-2 rounded-lg bg-primary/20 blur-md opacity-0 animate-pulse-slow" />
          <ThemeToggle />
        </div>
      </div>
        ...
        <div className="flex-1 relative overflow-hidden flex items-center justify-center">
          ...
          <div className="relative pl-20 pr-12 text-center">
            ...
            <h2 className="text-4xl font-black leading-tight mb-4 gradient-text">
              Turn Prospects<br />into Revenue
            </h2>

            <p className="text-sm text-muted-foreground/80 leading-relaxed max-w-sm mx-auto mb-8">
              Stop hunting. Start closing. Verified, high-intent leads delivered to your dashboard every single day.
            </p>
      ...
      <div className="hidden lg:block absolute left-[520px] top-1/2 -translate-y-1/2 z-20 animate-[fadeIn_0.8s_ease-out_forwards]">
        <FormCard showPassword={showPassword} setShowPassword={setShowPassword} form={form} onSubmit={onSubmit} isPending={login.isPending} />
      </div>
